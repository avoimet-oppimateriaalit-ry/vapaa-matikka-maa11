...
\begin{tehtava}
    ...
    \alakohdat{
        § $2^3 \cdot 3^2 \cdot 5^5 \cdot 7^5$ ja $2^5 \cdot 3^2 \cdot 5^2$
        § $2 \cdot 3 \cdot 5 \cdot 11$ ja $2 \cdot 3 \cdot 5 \cdot 11$
    }
...
\begin{tehtava}
    ...
    \begin{vastaus}
        \alakohdat{
            ...
            § Jos $p = kn$, niin pätee $2^p-1 = (2^{k})^{n} - 1 = (2^{k}-1)((2^{k})^{n-1}+\ldots+2^{k}+1)$,

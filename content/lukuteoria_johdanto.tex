...
\begin{center}
\includegraphics[width=7cm]{content/kuvitus/Bankautomat\vari}
\end{center}
...
%
%\begin{center}
%\includegraphics[width=10cm]{content/kuvitus/Berlin_marathon\vari}
%\end{center}
...
\begin{center}
\includegraphics[width=6cm]{content/kulmiot}
\end{center}
...
\item Todista kappaleessa 5.2 esiteltyjen kongruenssin laskusääntöjä koskevan lauseen kohta 4: Olkoot $a, b \in \zz$ ja $k, n \in \zz_+$ sekä $a \equiv b\ (\mod k)$. Tällöin $a^n \equiv b^n\ (\mod k)$.
...
\begin{center}
\includegraphics[width=10cm]{content/Kappale5_4_kuusikulm_v2}
\end{center}
...
\begin{center}
\includegraphics[width=6cm]{content/Kappale5_4_janat_v2}
\end{center}
...
\begin{center}
\includegraphics[width=10cm]{content/Kappale5_4_ruudukko_v2}
\end{center}

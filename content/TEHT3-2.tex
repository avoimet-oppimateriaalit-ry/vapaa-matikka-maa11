...
\begin{tehtava}
	...
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{Tiina lähettää tekstiviestin Eliakselle.}
			\alakohta{Elias ei lähetä tekstiviestiä Tiinalle ja Elias lähettää tekstiviestin Vilmalle.}
			\alakohta{$x$ lähettää tekstiviestin itselleen.}
			\alakohta{$y$ lähettää Rasmukselle tekstiviestin jos ja vain jos Rasmus lähettää $y$:lle tekstiviestin.}
		\end{alakohdat}
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$\{\textrm{Helsinki}, \textrm{Praha}\}$}
			\alakohta{$\{\textrm{Praha}, \textrm{Milano}\}$}
			\alakohta{$\{\textrm{Rovaniemi}\}$}
			\alakohta{$\{\textrm{Rovaniemi}, \textrm{Praha}, \textrm{Milano}\}$}
			\alakohta{$\{\textrm{Helsinki}, \textrm{Milano}\}$}
		\end{alakohdat}
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$\{1, 2, 3, 4, 6, 12\}$}
			\alakohta{$\{1, 4, 9, 16\}$}
			\alakohta{$\{9, 16\}$}
			\alakohta{$\{1, 4, 5, 7, 8, 10, 11, 13, 14, 15\}$}
		\end{alakohdat}
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$\{(1, 2, 2), (2, 1, 2), (2, 2, 1), (2, 2, 2)\}$}
			\alakohta{$\{(1, 1, 1)\}$}
			\alakohta{$\{(1, 1, 1), (2, 2, 2)\}$}
			\alakohta{$\emptyset$}
			\alakohta{$\{(1, 1, 2), (1, 2, 1), (1, 2, 2), (2, 1, 1), (2, 1, 2), (2, 2, 1), (2, 2, 2)\}$}
			\alakohta{$\{(1, 1, 2), (1, 2, 1), (2, 1, 1)\}$}
			\alakohta{$\{(1, 1, 2), (1, 2, 1), (1, 2, 2), (2, 1, 1), (2, 1, 2), (2, 2, 1)\}$}
		\end{alakohdat}
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	Ratkaise reaalilukujen joukossa.
	\begin{alakohdat}
	\alakohta{$(x^2 = 1) \lor (x(x + 5)(x - 1) = 0)$}
	\alakohta{$(x^2 = 1) \land (x(x + 5)(x - 1) = 0)$}
	\end{alakohdat}%
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$(x = -5) \lor (x = -1) \lor (x = 0) \lor (x = 1)$}
			\alakohta{$x = 1$}
		\end{alakohdat}
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$(x < 5) \lor (6 < x)$}
			\alakohta{$(-2 < x < 5) \lor (6 < x)$}
		\end{alakohdat}
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$x \in \mathbb{R}, x \in {]-\infty, \infty[}$}
			\alakohta{$-4 < x < 8, x \in {]-4, 8[}$}
			\alakohta{$-4 < x \le -3, x \in {]-4, -3]}$}
			\alakohta{$(x \le -5) \lor (-4 < x \le -3), (x \in {]-\infty, -5]} \lor (x \in {]-4, -3]})$}
		\end{alakohdat}
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$(x < 0) \lor (x \ge 20)$}
			\alakohta{$0 < x < 20$}
			\alakohta{$x \in \mathbb{R} \setminus \{0\} \Leftrightarrow x \ne 0$}
		\end{alakohdat}
	\end{vastaus}
\end{tehtava}

...
\begin{tehtava}
	...
	\begin{vastaus}
	a) $234 = 2\cdot 117$ b) $408 = -17\cdot (-24)$ c) $223 = 14\cdot15 + 13$ d) $-472 = 4\cdot (-79) + 2$
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{vastaus}
	a) $3 = 0\cdot 17 + 3$ b) $-3 = -1\cdot 17 + 14$ c) $88 = 1\cdot 80 + 8$ d) $-88 = -2\cdot 80 + 72$
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{vastaus}
	\alakohdat{
		§ Osamäärä $49$, jakojäännös $50$, jakoyhtälö $7^{50} + 1 = 7^2\cdot(7^{48} - 1) + 50$
		§ Osamäärä $7^{25} - 1$, jakojäännös $0$, jakoyhtälö $7^{50} - 1 = (7^{25} - 1)\cdot(7^{25} + 1) + 0$
	}
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{vastaus}
	\alakohdat{
		§ Osamäärä on $2n - 3$, jakojäännös 1, jakoyhtälö $2n^2-n-2 = (2n-3)(n+1). +1$
		§ Osamäärä on $n^2 - n + 2$, jakojäännös $2$, jakoyhtälö $n^3+n^2 + 6 = (n^2-n+2)(n+2) + 2$.
		§ Osamäärä $n + 2$, jakojäännös $-1$, jakoyhtälö $n^2 + 2n - 1 = (n+2)n -1$
	}
	\end{vastaus}
\end{tehtava}

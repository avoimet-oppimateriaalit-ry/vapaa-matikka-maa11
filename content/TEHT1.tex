...
\begin{tehtava}
    ...
    \begin{vastaus}
        \begin{alakohdat}
            \alakohta{Johtopäätös tehty vastaajien uskomuksesta.}%suomen kielessä ei vedetä vaan tehdään johtopäätöksiä
            \alakohta{Johtopäätös tehty Stephen Hawkingin uskomuksesta.}
...
\begin{tehtava}
    ...
    \begin{vastaus}
        \begin{alakohdat}
            ...
            \alakohta{On. Vastaoletuksesta ''Jollakin $C$ toteutuu $A$.'' on johdettavissa ristiriita.} % /Niko
        \end{alakohdat}
    \end{vastaus}
...
\begin{tehtava}
    ...
    \begin{vastaus}
        \begin{alakohdat}
            \alakohta{Ei.}
            \alakohta{Voi, koska Merimaalla ja Aurinkomaalla voi olla Lumimaan kanssa muutakin rajaa kuin länsiraja. Kuvan piirtäminen saattaa auttaa.} % /Niko
        \end{alakohdat}
    \end{vastaus}

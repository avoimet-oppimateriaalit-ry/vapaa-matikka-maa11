...
\numerointi{
	§ Mitä lukuja tarkoittaa merkintä $2n$, kun $n$ käy läpi kaikki luonnolliset luvut? Entä mitä lukuja 
		tarkoittaa merkintä $2n + 1$, kun $n\in \nn$?
	§ %Kaikki parilliset luvut voidaan esittää muodossa $2n$, missä $n$ on kokonaisluku. Esimerkiksi $12=2\cdot 6$.
		Esitä luvut $6$, $10$ ja $26$ muodossa $2n$.
	§ %Kaikki parittomat luvut voidaan esittää muodossa $2n + 1$, missä $n$ on kokonaisluku. 
		Esitä luvut $7$, $11$ ja $35$ muodossa $2n+1$.
	%§ Laske yhteen parittomia lukupareja. Esimerkiksi $5 + 7 =12$. Mitä havaitset summasta? 
		%Kahden parittoman luvun summa on aina \underline{\phantom{xxxxxxxxxx}}.
	%§ Todista edellisessä kohdassa muotoilemasi väite käyttäen kohdissa (1) ja (2) esitettyjä parillisten ja 
		%parittomien lukujen esitysmuotoja.
	%§ Todista väite matemaattisesti. Voit käyttää merkintöjä $2n$ ja $2n + 1$, $n\in\nn$.
	§ Laske yhteen parittomia lukuja. Esimerkiksi $5 + 7 = 12$. Mitä havaitset summasta?
	§ Todista havainto matemaattisesti. Kahdelle eri suurelle parittomalle luvulle voidaan käyttää yleisiä 
...
väite tekemällä ensin vastaoletus $\lnot B$, ja johtamaan tästä ristiriita joko vastaoletuksen, aksiooman tai aikaisemmin todistetun lauseen kanssa. Tästä seuraa, että alkuperäinen väitteen on oltava tosi.
